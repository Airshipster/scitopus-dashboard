...
Проект опубликован для некоммерческого использования с обязательным указанием источника: [github.com/Airshipster/scitopus-dashboard](https://github.com/Airshipster/scitopus-dashboard). Коммерческое использование не разрешено без отдельного письменного согласия разработчика данного репозитория.

Полные условия находятся в [`LICENSE.md`](LICENSE.md). Сторонние компоненты и референсы сохраняют собственные лицензии; они перечислены в [`THIRD_PARTY_NOTICES.md`](THIRD_PARTY_NOTICES.md).

## Атрибуция

Дашборд использует D3.js v7.9.0 как runtime-библиотеку для визуализации данных. Режим Race также указывает исходный референс по визуальному паттерну bar chart race, а ночная cyberpunk-стилистика отмечает визуальный референс по палитре и glow-подходу. Подробные сведения о сторонних компонентах и лицензиях находятся в [`THIRD_PARTY_NOTICES.md`](THIRD_PARTY_NOTICES.md).
