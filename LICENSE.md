...
- using the project or substantial parts of it in a paid product or paid service;
- using the project for client work, advertising, marketing, sponsorship, or monetized media;
...
This repository does not include the full production data used by the live dashboard. Any data published separately may have its own terms or access restrictions.

## Third-Party Components

Third-party libraries, code references, and visual references remain under their own licenses. See `THIRD_PARTY_NOTICES.md`.

This license does not restrict rights granted by third-party licenses for their own components.
